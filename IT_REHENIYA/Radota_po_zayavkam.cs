...
(
    ...
    int nHeightEllipse // width of ellipse
        ...
        private void Sotudniki_Load(object sender, EventArgs e)
        {
            ...
            this.заявкиTableAdapter.Fill(this._IT_REHENIYADataSet3.Заявки);
        ...
        public void method_add() {
            ...
            using (SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-BU1O7LB\SQLEXPRESS;Initial Catalog=IT-REHENIYA;Integrated Security=True"))
            {
                con.Open();
        ...
        public void method_save() {
            ...
            заявкиTableAdapter.Update((_IT_REHENIYADataSet3)заявкиBindingSource.DataSource);
