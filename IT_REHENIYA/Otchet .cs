...
(
    ...
    int nHeightEllipse // width of ellipse
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_IT_REHENIYADataSet2.Отчёты". При необходимости она может быть перемещена или удалена.
            this.отчётыTableAdapter.Fill(this._IT_REHENIYADataSet2.Отчёты);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_IT_REHENIYADataSet2.Отчёты". При необходимости она может быть перемещена или удалена.
            this.отчётыTableAdapter.Fill(this._IT_REHENIYADataSet2.Отчёты);
        ...
        public void method_save() {
            ...
            отчётыTableAdapter.Update((_IT_REHENIYADataSet2)отчётыBindingSource.DataSource);
