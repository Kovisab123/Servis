...
(
    ...
    int nHeightEllipse // width of ellipse
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_IT_REHENIYADataSet.Исполнители". При необходимости она может быть перемещена или удалена.
            this.исполнителиTableAdapter.Fill(this._IT_REHENIYADataSet.Исполнители);
        ...
        public void method_save() {
            ...
            исполнителиTableAdapter.Update((_IT_REHENIYADataSet)исполнителиBindingSource.DataSource);
